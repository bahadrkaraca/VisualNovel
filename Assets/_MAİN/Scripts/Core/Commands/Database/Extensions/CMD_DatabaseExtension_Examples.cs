...
namespace TESTING
{
    public class CMD_DatabaseExtension_Examples : CMD_DatabaseExtension
    {
        new public static void Extend(CommandDatabase database)
        {
            ...
            //Add lambda witth no parameters
            database.AddCommand("lambda", new Action(() => { Debug.Log("Printing a default messade to console from lambda command."); }));
        ...
        {
            Debug.Log("Printing a default messade to console.");
        }
        ...
        private static IEnumerator MoveCharacter(string direction)
        {
            ...
            //Get the variables I need. This Would be defined sonewhere else.
            Transform character = GameObject.Find("Image").transform;
            float moveSpeed = 15;

            //Calculate the target position for image
